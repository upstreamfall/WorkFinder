...
public interface Task extends WrappedIndividual {

    /* ***************************************************
     * Property http://www.semanticweb.org/pawel/ontologies/workfinder#isAssignedTo
     */
     
    /**
     * Gets all property values for the isAssignedTo property.<p>
     * 
     * @returns a collection of values for the isAssignedTo property.
     */
    Collection<? extends Programmer> getIsAssignedTo();

    /**
     * Checks if the class has a isAssignedTo property value.<p>
     * 
     * @return true if there is a isAssignedTo property value.
     */
    boolean hasIsAssignedTo();

    /**
     * Adds a isAssignedTo property value.<p>
     * 
     * @param newIsAssignedTo the isAssignedTo property value to be added
     */
    void addIsAssignedTo(Programmer newIsAssignedTo);

    /**
     * Removes a isAssignedTo property value.<p>
     * 
     * @param oldIsAssignedTo the isAssignedTo property value to be removed.
     */
    void removeIsAssignedTo(Programmer oldIsAssignedTo);
